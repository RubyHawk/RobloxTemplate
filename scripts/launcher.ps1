...
$runtimeAssetRoot = "assets\launcher\steampunk\runtime"
$shellTexture.Source = Get-LauncherImage "$detailedAssetRoot\iron-surface-detailed.png"
$workshopEmblem.Source = Get-LauncherImage "$runtimeAssetRoot\workshop-emblem.png"
$headerGauge.Source = Get-LauncherImage "$runtimeAssetRoot\pressure-gauge.png"
$blueprintImage.Source = Get-LauncherImage "$pngAssetRoot\boiler-blueprint.png"
$ventImage.Source = Get-LauncherImage "$runtimeAssetRoot\vent-grille.png"
$projectLabelImage.Source = Get-LauncherImage "$runtimeAssetRoot\parchment-label.png"
$panelCornerImage.Source = Get-LauncherImage "$runtimeAssetRoot\panel-corner-right.png"
